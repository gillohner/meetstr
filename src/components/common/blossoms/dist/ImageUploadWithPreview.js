...
var ImageUploadWithPreview = function (_a) {
  var _b = _a.initialPreview,
    initialPreview = _b === void 0 ? "" : _b,
    onImageUploaded = _a.onImageUploaded,
    onImageRemoved = _a.onImageRemoved,
    uploadFunction = _a.uploadFunction,
    _c = _a.showControls,
    showControls = _c === void 0 ? true : _c;
  var t = react_i18next_1.useTranslation().t;
  var showSnackbar = SnackbarContext_1.useSnackbar().showSnackbar;
  var _d = react_1.useState(initialPreview),
    preview = _d[0],
    setPreview = _d[1];
  ...
  return react_1["default"].createElement(
    ...
    !preview &&
      react_1["default"].createElement(
        Button_1["default"],
        {
          ...
          variant: "outlined",
          fullWidth: true,
          startIcon: react_1["default"].createElement(Image_1["default"], { color: "primary" }),
    ...
    preview &&
      react_1["default"].createElement(
        ...
        react_1["default"].createElement(
          Paper_1["default"],
          { elevation: 2, sx: { p: 1, width: "100%", bgcolor: "background.default" } },
          react_1["default"].createElement(
            Box_1["default"],
          ...
          react_1["default"].createElement(
            ...
            react_1["default"].createElement(
              Button_1["default"],
              {
                variant: "outlined",
                size: "small",
                startIcon: react_1["default"].createElement(Delete_1["default"], null),
