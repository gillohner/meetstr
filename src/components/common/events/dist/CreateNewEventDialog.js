...
function CreateNewEventDialog() {
  ...
  var _a = react_1.useState(false),
    open = _a[0],
    setOpen = _a[1];
  var _b = react_1.useState(dayjs_1["default"].tz.guess()),
    timezone = _b[0],
    setTimezone = _b[1];
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Event_1["default"], {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            material_1.Grid,
            { container: true, spacing: 2, direction: "row", sx: { marginTop: 1 } },
            React.createElement(
              material_1.Grid,
              { size: { xs: 12, md: 6 } },
              " ",
              React.createElement(
                ...
                React.createElement(
                  material_1.Grid,
                  { size: { xs: 12, md: 6 } },
                  React.createElement(FormTextField_1["default"], {
                    label: t("event.createEvent.form.title"),
                    name: "title",
                    icon: React.createElement(Event_1["default"], { color: "primary" }),
                    required: true,
                  })
                ),
                React.createElement(
                  ...
                  React.createElement(FormTextField_1["default"], {
                    ...
                    name: "description",
                    icon: React.createElement(Description_1["default"], { color: "primary" }),
                    multiline: true,
                  })
                )
              )
            ...
            React.createElement(
              ...
              React.createElement(
                material_1.Grid,
                { container: true, spacing: 2.5, direction: "column" },
                React.createElement(
                  material_1.Grid,
                  { size: 12 },
                  React.createElement(ImageUploadWithPreview_1["default"], {
                ...
                React.createElement(
                  ...
                  React.createElement(FormTextField_1["default"], {
                    ...
                    name: "location",
                    icon: React.createElement(LocationOn_1["default"], { color: "primary" }),
                  })
                )
              )
            ),
            React.createElement(
              material_1.Grid,
              { size: 12 },
              React.createElement(DateTimeSection_1["default"], {
                timezone: timezone,
          ...
          React.createElement(DialogActionsSection_1["default"], {
            onCancel: function () {
              return setOpen(false);
            },
