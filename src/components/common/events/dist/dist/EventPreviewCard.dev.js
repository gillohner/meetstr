...
var EventPreviewCard = function EventPreviewCard(_a) {
  ...
  var handleClick = function handleClick() {
    ...
    try {
      var dTag = ((_a = event.tags.find(function (t) {
        return t[0] === "d";
  ...
  return react_1["default"].createElement(material_1.Card, {
    sx: {
      display: "flex",
      flexDirection: {
        xs: "column",
  ...
  }, name), react_1["default"].createElement(EventTimeDisplay_1["default"], {
  ...
  }), react_1["default"].createElement(EventLocationText_1["default"], {
