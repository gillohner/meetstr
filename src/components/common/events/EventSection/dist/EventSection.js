...
var EventPreviewCard_1 = require("@/components/common/events/EventPreviewCard/EventPreviewCard");
var EventSection = function (_a) {
    ...
    return (react_1["default"].createElement(material_1.Box, { sx: { mb: 4 } },
        ...
        events.length > 0 ? (react_1["default"].createElement(material_1.Grid, { container: true, spacing: 3 }, events.map(function (event) { return (react_1["default"].createElement(material_1.Grid, { item: true, xs: 12, lg: 6, key: event.id || "event-" + event.id, sx: { width: "100%" } },
