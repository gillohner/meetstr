...
function EventOverview(_a) {
    ...
    var _b = useNostrEvent_1.useNostrEvent(), event = _b.event, loading = _b.loading, errorCode = _b.errorCode, fetchEvent = _b.fetchEvent;
    var expectedKinds = react_1.useMemo(function () { return [31922, 31923]; }, []);
    ...
    return (React.createElement(material_1.Container, { maxWidth: "lg", sx: { mb: 4 } },
        React.createElement(material_1.Card, { sx: { width: "100%", mb: 4 } },
            ...
            React.createElement(material_1.CardContent, null,
                React.createElement(material_1.Grid, { container: true },
                    React.createElement(material_1.Grid, { size: 9 },
        ...
        React.createElement(material_1.Grid, { container: true },
            ...
            React.createElement(material_1.Grid, { size: { xs: 12, md: 5, lg: 4 } },
                React.createElement(EventLocationMapCard_1["default"], { metadata: metadata }),
                React.createElement(EventAttendeesCard_1["default"], { participants: metadata.participants.map(function (p) { return ({ pubkey: p[0] }); }), event: event })))));
}
