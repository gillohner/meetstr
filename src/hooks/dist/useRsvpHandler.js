...
var rsvpUtils_1 = require("@/utils/rsvpUtils");
exports.useRsvpHandler = function (event) {
    ...
    var submitRsvp = function (status) { return __awaiter(void 0, void 0, void 0, function () {
        var rsvpEvent, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    rsvpEvent = rsvpUtils_1.createRsvpEvent(event, status);
    ...
    return { submitRsvp: submitRsvp, isSubmitting: isSubmitting, error: error };
};
